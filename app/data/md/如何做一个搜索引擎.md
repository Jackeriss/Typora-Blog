...
另外，Solr 默认的 JVM 堆内存大小是 512M，生产环境可以根据服务器的配置和需要进行调整：[http://lucene.apache.org/solr/guide/8_4/taking-solr-to-production.html#memory-and-gc-settings](http://lucene.apache.org/solr/guide/8_4/taking-solr-to-production.html#memory-and-gc-settings)。
